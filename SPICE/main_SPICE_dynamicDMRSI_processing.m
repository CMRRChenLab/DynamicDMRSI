...
%% Set Path
type = 'WholeBrain';
dataID = 'HC008';                              %%%% 'TP006'                       or 'HC031'
dataName = 'fid_combined5D_52measWSVD.mat';  %%%% 'fid_combined5D_34measWSVD_2' or 'fid_combined5D_42measWSVD'
...
num_throw = 0;
% usable frames
use_frame = 1:52;            %%% change this according to your use, 52, 20
% load data
...
save([SaveDataPath,'sxt_zp_corr.mat'],'sxt_dyn_highres_corr','sxt_dyn_highres','-v7.3');
...
save([SaveDataPath,'SpectralTemporalBases.mat'],'sxt_quant_profile','-v7.3');
...
save([SaveDataPath,'SpectralTemporalBases.mat'],'Vt_temporal','-v7.3');
...
save(fullfile(SaveDataPath,'processedData_XinCMBD_WSVD.mat'),...
           'sxt_orig',...
           'sxt_denoised',...
           'sxt_decomp',...
           'sxt_decomp_orig','-v7.3');
